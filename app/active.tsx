...
export default function ActiveWorkoutScreen() {
    ...
    // For adding new sets
    const [addingSetForExerciseId, setAddingSetForExerciseId] = useState<number | null>(null);
        ...
        <ThemedView style={styles.exerciseItem}>
            ...
            {addingSetForExerciseId === item.id ? (
                ...
                <Button
                    ...
                    type="outline"
                    icon={<Ionicons name="add-circle-outline" size={16} color="#1e88e5" />}
                    iconPosition="left"
    ...
    return (
        ...
        >
            <ThemedView style={styles.header}>
                ...
                <ThemedText>
                    Started: {workout ? new Date(workout.start_time).toLocaleString() : ''}
                </ThemedText>
                <Button
            ...
            <ThemedView style={styles.addExerciseContainer}>
                ...
                <ThemedView style={styles.exerciseTypeSelector}>
                    <ThemedView
                        ...
                        onTouchEnd={() => setShowExerciseTypeDropdown(!showExerciseTypeDropdown)}
                    >
